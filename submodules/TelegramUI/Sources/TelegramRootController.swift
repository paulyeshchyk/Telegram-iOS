...
public final class TelegramRootController: NavigationController {
    ...
    public func addRootControllers(showCallsTab: Bool) {
        ...
        let accountSettingsController = PeerInfoScreenImpl(context: self.context, updatedPresentationData: nil, peerId: self.context.account.peerId, avatarInitiallyExpanded: false, isOpenedFromChat: false, nearbyPeerDistance: nil, callMessages: [], worldClockText: "Lorem ips 5", isSettings: true)
